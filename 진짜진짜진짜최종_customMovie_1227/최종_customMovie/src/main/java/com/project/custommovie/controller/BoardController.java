...
public class BoardController {
    ...
    public String saveForm(){
        return "/board/save";       //templates/board/save.html띄어줌
    }

    //form에서 작성한값을 controller로 보내줘야함
    ...
    public String save(@ModelAttribute BoardDTO boardDTO){      //1. 입력한 값을 controller로 가져오기 위해서 @RequestParam으로 받아도 되지만,
        ...
        return "/board/paging";     //save하고 나서 index로 보냄 => paging으로 보냄
    }
    ...
    public String findById(@PathVariable Long id, Model model,
        ...
        */
        ...
        return "/board/detail";        //detail.html로 넘어간다.               //4. html로 넘어감
    }
...
//        pageable.getPageNumber();       //몇 페이지가 요청됐는지 값을 사용할 수 있음
        ...
        return "/board/paging";            //paging.html로 넘어감
