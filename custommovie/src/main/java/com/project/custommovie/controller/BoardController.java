...
import com.project.custommovie.service.BoardService;
...
public class BoardController {
    ...
    public String boardhome() {
        ...
        return "redirect:/board/home.html";
    }
    ...
    public String save(@ModelAttribute BoardDTO boardDTO){      //1. 입력한 값을 controller로 가져오기 위해서 @RequestParam으로 받아도 되지만,
        ...
        return "redirect:/board/home.html";     //save하고 나서 index로 보냄
    }
    ...
    public String findById(@PathVariable Long id, Model model,
        ...
        */
        ...
        return "redirect:/board/detail.html";        //detail.html로 넘어간다.               //4. html로 넘어감
    }
    ...
    public String updateForm(@PathVariable Long id, Model model){        //데이터를 반환해야하므로 model이 필요함
        ...
        return "redirect:/board/update.html";
    }
    ...
    public String update(@ModelAttribute BoardDTO boardDTO, Model model){
        ...
        return "redirect:/board/detail.html";
...
//        pageable.getPageNumber();       //몇 페이지가 요청됐는지 값을 사용할 수 있음
        ...
        return "redirect:/board/paging.html";            //paging.html로 넘어감
